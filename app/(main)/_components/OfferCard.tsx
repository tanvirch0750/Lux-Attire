...
export default function OfferAndFreeShippingBanner() {
  return (
    <div className="flex flex-col md:flex-row w-full md:h-screen">
      {/* Left Banner */}
      <div className="relative w-full md:w-1/2 bg-[#fce4e4] overflow-hidden">
        <Image
          src={Img1}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-white bg-opacity-80 rounded-full w-[280px] h-[280px] flex flex-col items-center justify-center p-8">
            <p className="text-md font-semibold text-brand mb-2">
              SALE UP TO 50% OFF
            </p>
            ...
            <Link href="/products/discount-products">
              <Button
                variant="outline"
                className="rounded-full px-6 bg-primary text-white hover:bg-primary/90 hover:text-white"
              >
                SHOP NOW
              </Button>
            </Link>
      ...
      {/* Right Banner */}
      <div className="relative w-full md:w-1/2 bg-pink-200 overflow-hidden">
        <Image
          src={Img2}

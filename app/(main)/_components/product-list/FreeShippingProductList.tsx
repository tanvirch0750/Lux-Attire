...
import { getProductsWithFreeShippingOffers } from '@/db/actions-and-queries/products/products-queries';

export default async function FreeShippingProductList({
  filters,
}: {
  filters: IFilters;
}) {
  const products: TProduct[] = await getProductsWithFreeShippingOffers();

...
import { getProductsWithDiscountOffers } from '@/db/actions-and-queries/products/products-queries';

import NoProductsFound from './NoProductsFound';
import { IFilters } from '../../products/[category]/page';

export default async function DiscountProductList({
  filters,
}: {
  filters: IFilters;
}) {
  const products: TProduct[] = await getProductsWithDiscountOffers();
